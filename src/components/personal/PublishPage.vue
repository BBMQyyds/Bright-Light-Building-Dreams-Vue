<template>
  <div v-if="this.$route.query.type === 'tale'" class="page-tale">

    <div class="tinymce-boxz">
      <Editor v-model="content" :api-key="apiKey" :init="init"/>
    </div>
  </div>
  <div v-if="this.$route.query.type === 'segment'" class="page-tale">
...
export default {
  ...
  setup() {
    if (!useStore().state.user) {
      ...
      const tiny = reactive({
        apiKey: "66wnow695vpq9nggjzsdugo5i6asqn3zaykwqjywb08mr8pm",
