<template>
    <div class="main">
        <el-row class="row">
            <el-col :span="12">
                <el-input class="search" v-model="searchKeyword" placeholder="搜索志愿者账户"></el-input>
            </el-col>
        </el-row>
        <el-table
                ref="table"
            ...
            <el-table-column label="操作" width="225">
                <template v-slot="scope">
                    <div style="display: flex; justify-content: center; margin-left: 15px">
                        <el-button type="warning" size="default" @click="editVolunteer(scope.row)">编辑</el-button>
                        <el-button type="danger" size="default" @click="deleteVolunteer(scope.row)">删除</el-button>
                    </div>
                </template>
            </el-table-column>
        </el-table>
